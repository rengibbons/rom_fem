...
% Thermal properties
alpha = 1e-2;%17.3e-3; % thermal expansion
k     = 1e-10;%6;    % conductivity 8 is standard
c     = 1e-8;    % capacity
rho   = 1.1;     % density
T0    = 20;      % initial temp
...
define_BC.EDISP=[2 0.1 0 disp 0;
                 1 0.1 0 0 Tinc];
% define_BC.EDISP=[2 0.1 0 disp 0]; % works well. III has good conv
% define_BC.EDISP=[1 0.1 0 0 Tinc];
